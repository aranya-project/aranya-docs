...
| [Branch Protections](#branch-protections) | Enable "Require review from Code Owners" at org level (currently configured at repo level) | org | all |
| [CI/CD](#cicd) | Update [`release.yml`](https://github.com/aranya-project/aranya/blob/main/.github/workflows/release.yml) trigger to include `push: release/**/*` | repo (workflow) | aranya |
...
- **`release/**/*`** -- used for patch releases and any other releases not performed from `main`. Requires a wildcard branch protection rule at the org level. -- **TODO** ([aranya#730](https://github.com/aranya-project/aranya/issues/730))
...
| Require review from Code Owners | Enabled | repo | Configured (repo-level rulesets) | **TODO**: move to org level for consistency; at least one CODEOWNERS reviewer must approve |
...
|---|---|---|---|---|---|
| Deployment branches | `main` and `release/**/*` | env-level: `release` | -- | aranya: Configured; aranya-core: **TODO** | Restricts which branches can deploy to this environment |
