...
<img src="{{ '/assets/images/beta/new_daemon_arch_block.png' | relative_url }}" class="doc-image" alt="daemon subsystems" />

<img src="{{ '/assets/images/beta/new_daemon_arch_block_detail.png' | relative_url }}" class="doc-image" alt="daemon subsystems with additional detail" />
